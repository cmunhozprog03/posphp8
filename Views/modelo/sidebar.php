            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="vendas" class="nav-link">
                  <i class="far fas fa-circle nav-icon text-success"></i>
                  <p>Administrar Vendas</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="nova-venda" class="nav-link">
                  <i class="far fas fa-circle nav-icon text-info"></i>
                  <p>Nova venda</p>
                </a>
              </li>
              
              <li class="nav-item">
                <a href="relatorios-de-vendas" class="nav-link">
                  <i class="far fas fa-circle nav-icon text-primary"></i>
                  <p>Relatórios de venda</p>
                </a>
              </li>
            </ul>
          </li>
